...
<xsl:text>{
  ...
  _stack[_sp++].d = (double) _op1.i;</xsl:text>
    ...
    <xsl:text>[_op1.o retain];
            ...
            <xsl:text>) _op2.o) _set_</xsl:text>
            <xsl:value-of select="vm:fixname(@field)"/>
            <xsl:text>_</xsl:text>
            <xsl:value-of select="vm:fixname(@type)"/>
            <xsl:text>] release];
  ...
  <xsl:text>    _op1.i = _stack[--_sp].i;
    _op2.o = _stack[--_sp].o;
    _stack[_sp++].i = [((XMLVMArray*) _op2.o) get_array].i[_op1.i];
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    _op1.i = _stack[--_sp].i;
    _op2.o = _stack[--_sp].o;
    _stack[_sp++].d = [((XMLVMArray*) _op2.o) get_array].d[_op1.i];
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    _op1.i = _stack[--_sp].i;
    _op2.o = _stack[--_sp].o;
    _stack[_sp++].f = [((XMLVMArray*) _op2.o) get_array].f[_op1.i];
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    _op1.i = _stack[--_sp].i;
    _op2.i = _stack[--_sp].i;
    _op3.o = _stack[--_sp].o;
    [((XMLVMArray*) _op3.o) get_array].i[_op2.i] = _op1.i;
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    _op1.d = _stack[--_sp].d;
    _op2.i = _stack[--_sp].i;
    _op3.o = _stack[--_sp].o;
    [((XMLVMArray*) _op3.o) get_array].d[_op2.i] = _op1.d;
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    _op1.f = _stack[--_sp].f;
    _op2.i = _stack[--_sp].i;
    _op3.o = _stack[--_sp].o;
    [((XMLVMArray*) _op3.o) get_array].f[_op2.i] = _op1.f;
</xsl:text>
    </xsl:template>
  ...
  <xsl:text>    [_ex release];
   ...
   _r</xsl:text><xsl:value-of select="@vx"/><xsl:text>.o = JAVA_NULL;
    ...
    <xsl:template match="dex:aget-object">
        ...
        <xsl:value-of select="@vy"/>
        <xsl:text>.o) get_array].o[_r</xsl:text>
        <xsl:value-of select="@vz"/>
        <xsl:text>.i];
</xsl:text>
    </xsl:template>
