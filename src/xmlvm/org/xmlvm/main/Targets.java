...
public enum Targets {
    ...
    NONE, XMLVM, DEXMLVM, JVM, CLR, DFA, CLASS, EXE, DEX, JS, JAVA, JSANDROID, C, POSIX, GENCWRAPPERS,
    PYTHON, OBJC, QOOXDOO, IPHONE, IPHONEC, IPHONECANDROID, VTABLE, WEBOS, CSHARP, WINOBJC,
    IPHONETEMPLATE(SKELETON), ANDROIDTEMPLATE(SKELETON), ANDROIDMIGRATETEMPLATE(SKELETON),
    IPHONEUPDATETEMPLATE(SKELETON), ANDROIDUPDATETEMPLATE(SKELETON), WP7, WP7ANDROID, GENCSHARPWRAPPERS,
    IPHONEHYBRIDTEMPLATE(SKELETON), SDLANDROID;
